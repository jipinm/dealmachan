                ...
                <form method="POST" action="<?= BASE_URL ?>merchants/edit-store?id=<?= $store['id'] ?>" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="url" name="website_link" class="form-control" maxlength="255"
                               placeholder="https://" value="<?= escape($_POST['website_link'] ?? $store['website_link'] ?? '') ?>">
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="number" name="latitude" class="form-control" step="0.00000001" min="-90" max="90"
                                   placeholder="e.g. 10.85052" value="<?= escape($_POST['latitude'] ?? $store['latitude'] ?? '') ?>">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Longitude</label>
                            <input type="number" name="longitude" class="form-control" step="0.00000001" min="-180" max="180"
                                   placeholder="e.g. 76.27108" value="<?= escape($_POST['longitude'] ?? $store['longitude'] ?? '') ?>">
                        </div>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <?php $beChecked = (int)($_POST['booking_enabled'] ?? $store['booking_enabled'] ?? 0); ?>
                        ...
                        <div id="bookingConfirmWrap" style="<?= $beChecked ? '' : 'display:none' ?>">
                            <div class="form-check form-switch ms-3">
                                <input class="form-check-input" type="checkbox" name="booking_confirmation_required" id="bookingConfirmRequired" value="1"
                                       <?= (int)($_POST['booking_confirmation_required'] ?? $store['booking_confirmation_required'] ?? 0) ? 'checked' : '' ?>>
